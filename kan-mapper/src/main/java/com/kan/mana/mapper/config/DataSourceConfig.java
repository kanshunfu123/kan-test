package com.kan.mana.mapper.config;
...
public class DataSourceConfig {
     ...
     */
    private static String MAPPER_PATH = "/com/kan/mana/mapper/**/*.xml";
    private static String TYPE_ALIASES_Package = "com.kan.mana.mapper.dataobject";
    static final String PACKAGE = "com.kan.mana.mapper.mapper";
    @Autowired
